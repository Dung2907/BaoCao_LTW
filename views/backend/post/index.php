                     ...
                     <tr class="datarow">
                        ...
                        <td>
                           ...
                           <div class="function_style">
                              ...
                              <?php endif; ?>
                              <a class="btn btn-primary" href="index.php?option=post&cat=edit&id=<?= $items->id; ?>"><i class=" fas fa-pen"></i>Chỉnh sửa</a>
                              <a class="btn btn-info" href="index.php?option=post&cat=show&id=<?= $items->id; ?>"><i class=" fas fa-eye"></i>Chi tiết</a> |
                              <a class="btn btn-danger" href="index.php?option=post&cat=delete&id=<?= $items->id; ?>"><i class=" fas fa-trash"></i>Xoá</a>
                           </div>
                        </td>
