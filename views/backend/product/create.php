            ...
            <div class="card-body">
               ...
               <div class="row">
                  <div class="col-md-8">
                     ...
                     <div class="mb-3">
                        <label>Mô tả (*)</label>
                        <textarea name="description" placeholder="Nhập chi tiết sản phẩm" rows="5" class="form-control"></textarea>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="mb-3">
                        <label>Giá bán (*)</label>
                        <input type="number" value="100000" min="1000" name="price" class="form-control">
                     </div>
                     <div class="mb-3">
                        <label>Giá sale (*)</label>
                        <input type="number" value="100000" min="1000" name="price_sale" class="form-control">
                     </div>
                     <div class="mb-3">
