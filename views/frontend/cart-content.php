                ...
                <tbody>
                    <?php if (count($listcart) > 0) : ?>
                        ...
                        <?php foreach ($listcart as $cart) : ?>
                            <?php $monney_item = $cart['qty'] * $cart['price']; ?>
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" value="<?= number_format($cart['qty']); ?>" min="0" id="qty" name="qty[<?= $cart['id']; ?>]" style="width:60px;">

                                    </div>
                                </td>
                                <td class="text-center align-middle">
                                    <?= number_format($monney_item); ?>
                                </td>
                                 <td class="text-center align-middle">
                    ...
                    <?php else : ?>
                        <tr>
                            <td colspan="7" class="text-center"><strong>Chưa có trong giỏ hàng</strong></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <td colspan="2" class="text-end">
                            <strong>Tổng tiền:<?= number_format(cart::cartTotal()); ?> đồng</strong>
                        </td>
                    </tr>
                </tfoot>
            </table>
