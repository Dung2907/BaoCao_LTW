      ...
      <div class="row">
            ...
            <form action="index.php?option=checkout" method="post">
               ...
               <?php if (isset($_SESSION['iscustom'])) : ?>
                  <div class="mb-3">
                     ...
                     <input type="text" name="name" value="<?= $customer->name; ?>" id="name" class="form-control" placeholder="Nhập họ tên" readonly>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                     <label for="phone">Điện thoại</label>
                     <input type="text" value="<?= $customer->email; ?>" name="email" id="email" class="form-control" placeholder="Nhập điện thoại">
                  </div>
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="mb-3">
                           ...
                           <input type="text" value="<?= $customer->address; ?>" name="address" id="address" class="form-control" placeholder="Nhập địa chỉ">
                        </div>
                        <!-- <div class="row">
                        <div class="col-4">
                  ...
                  <div class="thanhtoan mb-4">
                     ...
                     <div class="p-4 border bankinfo">
                        ...
                        <p>STK:21801637</p>
                        <p>Chủ tài khoản:Trần Anh Dũng</p>
                     </div>
                  </div>
         ...
         <div class="col-md-6">
            ...
            <table class="table table-borderless">
               ...
               <tbody>
                  ...
                  <?php foreach ($listcart as $item) : ?>
                     ...
                     <tr>
                        <td class="text-center align-middle"><?php $stt; ?></td>
                        <td>
               ...
               <tfoot>
                  <tr>
                     <td colspan="6" class="text-end">
                        <strong>Tổng:<?= number_format(cart::cartTotal()); ?> đồng</strong>
                     </td>
                  </tr>
               </tfoot>
            </table>
            ...
            <table class="table table-borderless">
               <tr>
                  <th>Tạm tính</th>
                  <td class="text-end"><?= number_format(cart::cartTotal()); ?>đồng</td>
               </tr>
               <tr>
